...
<section class='grid'>
  <article class='card mini'><div class='eyebrow'>Page direction</div><h2>How this page should feel</h2><p>{html.escape(p['copy_2'])}</p></article>
  <article class='card mini'><div class='eyebrow'>Why it matters</div><h2>Role in the overall portfolio</h2><p>{html.escape(p['summary'])}</p></article>
  <article class='card mini'><div class='eyebrow'>Best next upgrade</div><h2>What to add next</h2><p>{html.escape(p['copy_3'])}</p></article>
</section>
<div class='footer'>This local page uses public media pulled from the corresponding live project page so the prototype no longer relies on mismatched or cross-project visuals.</div>
</div>
</body>
</html>"""
