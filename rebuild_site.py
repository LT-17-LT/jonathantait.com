  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width:780px) {
      ...
      h1 { max-width:none; }
      .overlay-panel { left:16px; right:16px; width:auto; bottom:28px; }
      .service-stack { min-height:132px; }
      .overlay-title { max-width:14ch; font-size:clamp(1.55rem,7vw,2.2rem); }
    }
